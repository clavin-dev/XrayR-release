...
Find the source code here: [clavin-dev/XrayR](https://github.com/clavin-dev/XrayR)
...
```
bash <(curl -Ls https://raw.githubusercontent.com/clavin-dev/XrayR-release/master/install.sh)
```
# Docker 安装
...
```
1. `git clone https://github.com/clavin-dev/XrayR-release`
2. `cd XrayR-release`
3. 编辑config。
